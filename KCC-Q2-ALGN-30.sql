...
(
	...
	WHERE BLD_RUN_SK = 20201103104930 --20200929093734 -- 20200929093734
	AND ALGN.PROS_BENE_DSGNTN_CD = 'CKD'
)
SELECT BENE_SK,
	   SUM(CASE WHEN CURR_UNDER_18_IND='Y' THEN 1 ELSE 0 END)/COUNT(*) AS YES_CNT_U18
FROM CNT_BTH_DT_TEST
WHERE BENE_AGE_RUN_DT < 18 
AND CURR_UNDER_18_IND = 'Y'
GROUP BY BENE_SK
HAVING YES_CNT_U18 < 1
;
